...
class Estatik
{
     ...
     * @var string
     */
    protected static $_version = '3.8.4';
    ...
    public static function property_slug( $args, $post_type ) {
        ...
        if ( Es_Property::get_post_type_name() === $post_type ) {
            global $es_settings;
    ...
    public function init()
    {
        ...
        if ( is_admin() ) {
            ...
            if ( $post_type == Es_Property::get_post_type_name() ) {
    ...
    public function enqueue_scripts()
    {
	    ...
	    wp_enqueue_script(
		    ...
		    array ( 'jquery', 'es-select2-script' )
	    );
    }
    ...
    public function enqueue_styles()
    {
        ...
        // Register base styles for the plugin.
        wp_register_style( 'es-magnific-style', ES_PLUGIN_URL . $vendor . 'magnific-popup.css' );
    }
    ...
    public function admin_enqueue_styles()
    {
	    ...
	    wp_register_style( 'es-magnific-style', ES_PLUGIN_URL . $vendor_main . 'magnific-popup.css' );
