...
class Es_Profile_Shortcode extends Es_Shortcode {
	...
	public function build( $atts = array() ) {
		...
		wp_enqueue_style( 'es-profile-style', ES_PLUGIN_URL . 'assets/css/custom/profile.css', array( 'es-slick-style' ) );
		wp_enqueue_script( 'es-tabs', ES_PLUGIN_URL . 'assets/js/custom/tabs.js', array( 'jquery', 'es-slick-script' ) );
