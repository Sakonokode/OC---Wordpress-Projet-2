...
class Es_Property_Slideshow_Shortcode extends Es_My_Listing_Shortcode
{
	...
	public function property_loop( $query_args, $atts )
	{
		...
		if ( ! empty( $posts ) ) {
			...
			global $estatik_slideshow_settings;

			$estatik_slideshow_settings[ $uid ] = $atts;

			wp_localize_script( 'es-property-slideshow-shortcode', 'Estatik_Slideshow', $estatik_slideshow_settings );
